...
public class Main {
  public static void main(String[] args) {
    ...
    Viewer viewer = new Viewer(origin,width,height,density,dir,right,1,lights,world);
    ...
    img.setRGB(0,0,width*density,height*density,viewer.getLightColorArray(512,4,.5),0,width*density);
