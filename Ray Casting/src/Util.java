public class Util {
  ...
  */
  public static double dot(double[] a, double[] b) {
    if(a.length != b.length) throw new IllegalArgumentException("Vectors have to be of equal dimensions");
    double ret = 0;
  ...
  * <p>ifthe length of p is 2 the value 1 is assumed forr</p>
  ...
  */
  ...
  public static double[] sub(double[] a, double[] b) {
    if(a.length != b.length) throw new IllegalArgumentException("Vectors have to have equal dimensions");
